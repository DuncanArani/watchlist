...
class TestReview(unittest.TestCase):
    ...
    def setUp(self):
        self.user_Dunco = User(
            username='Dunco', password='31740141', email='aruncodunco@gmail.com')
        self.new_review = Review(movie_id=12345, movie_title='Review for movies', image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",
                                 movie_review='This movie is the best thing since sliced bread', user=self.user_Dunco)
